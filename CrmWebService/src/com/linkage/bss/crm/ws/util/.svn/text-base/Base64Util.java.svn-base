...
public class Base64Util {
    ...
    public static String getBase64(String filename) {
        ...
        String base64 = null;
        try {
            base64 = Base64.encodeToString(FileUtils.readFileToByteArray(new File(filename)), Base64.NO_WRAP);
    ...
    public static String getBase64(File file) {
        ...
        String base64 = null;
        try {
            base64 = Base64.encodeToString(FileUtils.readFileToByteArray(file), Base64.NO_WRAP);
