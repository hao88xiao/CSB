...
<response>
	...
	<prodRecords>
		...
		<prodRecord>
			...
			<linkEmailAddress>${resultProdInfoMap.profiles.LINK_EMAIL_ADDRESS!""}</linkEmailAddress>
			<#else>
			...
			<productInfo>
			    ...
			    <addressDesc>${resultProdInfoMap.addressDesc!""}</addressDesc>
			    <description>${resultProdInfoMap.description!""}</description>
			    <managerName>${resultProdInfoMap.managerName!""}</managerName>
			    <tmlName>${resultProdInfoMap.tmlName!""}</tmlName>
			    <staffOrgId>${resultProdInfoMap.staffOrgId!""}</staffOrgId>
			    <bsdevdep>${resultProdInfoMap.bsdevdep!""}</bsdevdep>
...
<#-- 非主接入号-->
				<#if  resultProdInfoMap.offerProd2Numbers??>		    
			    <#list resultProdInfoMap.offerProd2Numbers.offerProd2AccessNumbers as offerProd2AccessNumbers>
				<prod2AccNbr>${offerProd2AccessNumbers.accessNumber!""}</prod2AccNbr>
				<prod2AccNbrType>${offerProd2AccessNumbers.accessNumberType.anTypeCd!""}</prod2AccNbrType>
				<prod2AccNbrTypeName>${offerProd2AccessNumbers.accessNumberType.name!""}</prod2AccNbrTypeName>
				</#list>
				<#else>
				<prod2AccNbr></prod2AccNbr>
				<prod2AccNbrType></prod2AccNbrType>
				<prod2AccNbrTypeName></prod2AccNbrTypeName>
				</#if>
...
<#--关联产品-->	
				<prod2prods>
					...
					<prod2prod>
						<relaprodAccNbr>${p2p.accessNumber!""}</relaprodAccNbr>
